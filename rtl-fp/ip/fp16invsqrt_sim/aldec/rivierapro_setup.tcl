...
# ACDS 23.1 993 linux 2024.11.16.14:36:08
# ----------------------------------------
...
# ----------------------------------------
# If fp16invsqrt is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "fp16invsqrt"
}
...
alias com {
  echo "\[exec\] com"
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/fp16invsqrt.vo"
}
