...
# ACDS 23.1 993 linux 2024.11.16.14:55:06
# ----------------------------------------
...
# ----------------------------------------
# If int_to_fp16 is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "int_to_fp16"
}
...
alias com {
  echo "\[exec\] com"
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/int_to_fp16.vo"
}
