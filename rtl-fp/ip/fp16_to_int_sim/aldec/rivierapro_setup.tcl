...
# ACDS 23.1 993 linux 2024.11.16.14:34:28
# ----------------------------------------
...
# ----------------------------------------
# If fp16_to_int is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "fp16_to_int"
}
...
if ![info exists QUARTUS_INSTALL_DIR] { 
  set QUARTUS_INSTALL_DIR "/home/aidanmmulv/intelFPGA_lite/23.1std/quartus/"
}
...
alias com {
  echo "\[exec\] com"
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/fp16_to_int.vo"
}
